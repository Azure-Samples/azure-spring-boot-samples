...
az ad app update --id $env:RESOURCE_SERVER_2_CLIENT_ID --identifier-uris api://$env:RESOURCE_SERVER_2_CLIENT_ID
...
echo RESOURCE_SERVER_2_CLIENT_ID=$env:RESOURCE_SERVER_2_CLIENT_ID
