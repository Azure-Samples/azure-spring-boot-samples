...
[config for resource server obo]: https://github.com/Azure-Samples/blob/main/azure-spring-boot-samples/aad/azure-spring-boot-sample-active-directory-resource-server-obo#configure-your-middle-tier-web-api-a