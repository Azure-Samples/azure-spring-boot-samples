...
[azure-spring-boot-sample-keyvault-certificates-client-side]: https://github.com/Azure-Samples/blob/main/azure-spring-boot-samples/keyvault/azure-spring-boot-sample-keyvault-certificates-client-side
