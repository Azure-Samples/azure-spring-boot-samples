...
[application.yaml]: https://github.com/Azure-Samples/azure-spring-boot-samples/blob/main/eventhubs/eventhubs-multibinders/src/main/resources/application.yaml
