...
## What You Will Build
You will build an application using Spring JMS to send and receive messages with Azure Service Bus Topic.
...
azurecaf_name.servicebus_namespace_authorization_rule: Creation complete ...
...
azurerm_servicebus_topic.application: Creation complete after ...
...
azurerm_servicebus_subscription.application: Creation complete after ...
