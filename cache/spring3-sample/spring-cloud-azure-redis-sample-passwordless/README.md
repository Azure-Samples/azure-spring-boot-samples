...
This code sample demonstrates how to use [passwordless connections](https://learn.microsoft.com/azure/developer/intro/passwordless-overview) to cache data in [Azure Cache for Redis](https://azure.microsoft.com/products/cache/) using the [Spring Cloud Azure Starter Data Redis lettuce](https://learn.microsoft.com/en-us/azure/developer/java/spring-framework/redis-support).
