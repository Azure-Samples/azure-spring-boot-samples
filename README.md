...
This project uses one pom file to manage the samples for Spring Cloud Azure 4.x and Spring Cloud Azure 6.x, the profile `spring-cloud-azure-4.x` is activated by default.
