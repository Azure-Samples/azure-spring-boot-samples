...
| keyvault         | [azure-spring-boot-starter-keyvault-certificates:3.13.0]                                          | [keyvault-certificates-server-side](keyvault/azure-security-keyvault-jca/run-with-command-line-server-side)   |
