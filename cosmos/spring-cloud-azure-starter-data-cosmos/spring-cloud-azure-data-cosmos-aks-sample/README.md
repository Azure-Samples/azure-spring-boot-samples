...
- [Java Development Kit (JDK) 8](https://www.oracle.com/java/technologies/downloads/). Point your `JAVA_HOME` environment variable to the path where the JDK is installed.
