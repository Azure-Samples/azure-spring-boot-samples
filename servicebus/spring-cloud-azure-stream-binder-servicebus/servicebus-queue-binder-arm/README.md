# Spring Cloud Azure Stream Binder for Service Bus queue by ARM Authentication Sample shared library for Java


This code sample demonstrates how to use the Spring Cloud Stream binder for
Azure Service Bus queue by Azure Resource Manager Authentication. 


## What You Will Build
You will build an application using Spring Cloud Stream to send and receive messages for Azure Service Bus Queue, and  a service principal for this application.
