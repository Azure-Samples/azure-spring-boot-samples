...
## What You Will Build
You will build an application using the Spring Cloud Azure Starter Data Redis Lettuce, Spring Cloud Azure Resource Manager and Spring Boot Starter Data Redis to cache data to Azure Cache for Redis.
