...
products:
- azure-service-bus
name: Sending and Receiving Message by Azure Service Bus (Queue) in Spring Boot Application
description: This sample demonstrates how to send and receive message by Azure Service Bus (queue) in Spring Boot application.
---

# Sending and Receiving Message by Azure Service Bus (Queue) in Spring Boot Application

This sample project demonstrates how to use the Service Bus Java clients in the context of a Spring application via Spring Boot Starter `spring-cloud-azure-starter-servicebus`.

## What You Will Build
You will build an application using ServiceBusSenderClient and ServiceBusProcessorClient to send and receive messages for Azure Service Bus Queue.
...
1. Verify in your app's logs that a similar message was posted:
    ...
    ...
    Processing message. Id: xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx, Sequence #: 1. Contents: Hello, World!
    ```
