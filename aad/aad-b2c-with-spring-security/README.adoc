...
We need to get related access token before we access this resource server, please refer to <<Sample-05-client-access-resource-server, Sample-05-client-access-resource-server>>.
...
We need to get related access token before we access this resource server, please refer to <<Sample-07-client-access-resource-server-validate-audience, Sample-07-client-access-resource-server-validate-audience>>.
