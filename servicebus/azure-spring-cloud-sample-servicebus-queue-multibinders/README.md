...
[application.yaml]: https://github.com/Azure-Samples/azure-spring-boot-samples/servicebus/azure-spring-cloud-sample-servicebus-queue-multibinders/src/main/resources/application.yaml
