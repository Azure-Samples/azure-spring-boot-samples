...
def main():
    ...
    keyVaultJcaManagedIdentitySample_path = os.path.abspath("../keyvault/keyvault-certificates-client-side/src/main/java/com/azure/spring/security/keyvault/KeyVaultJcaManagedIdentitySample.java")
    ...
    readmePath = "../keyvault/keyvault-certificates-client-side/README.md"
