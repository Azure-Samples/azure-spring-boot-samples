...
public class ExtendAzureStorageBlobProperties extends AzureStorageProperties implements BlobServiceClientProperties {

    public static final String EXTEND_PREFIX = "extend.spring.cloud.azure.storage.blob";
