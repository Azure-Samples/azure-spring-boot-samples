...
import com.azure.spring.sample.storage.resource.extend.storage.blob.ExtendAzureStorageBlobProperties;
...
import static com.azure.spring.sample.storage.resource.extend.storage.blob.ExtendAzureStorageBlobProperties.EXTEND_PREFIX;
...
public class ExtendStorageAccountAutoConfiguration {
    ...
    @ConditionalOnMissingBean(name = EXTEND_STORAGE_BLOB_PROPERTIES_BEAN_NAME)
