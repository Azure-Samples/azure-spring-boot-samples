...
[application.yaml]: https://github.com/Azure-Samples/azure-spring-boot-samples/blob/main/servicebus/servicebus-queue-multibinders/src/main/resources/application.yaml
