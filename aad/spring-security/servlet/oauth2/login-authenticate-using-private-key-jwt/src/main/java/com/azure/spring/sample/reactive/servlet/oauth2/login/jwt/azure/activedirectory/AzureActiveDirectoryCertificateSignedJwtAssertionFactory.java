...
public class AzureActiveDirectoryCertificateSignedJwtAssertionFactory {
    ...
    /**
     * @param file Path of file. The file should contain encrypted private key and certificate. And the file name should
     * have ".pfx" as suffix.
    ...
    public String createJwtAssertion() throws JOSEException {
