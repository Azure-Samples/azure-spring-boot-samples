...
[application.yaml]: https://github.com/Azure-Samples/blob/main/azure-spring-boot-samples/servicebus/azure-spring-cloud-sample-servicebus-queue-multibinders/src/main/resources/application.yaml
