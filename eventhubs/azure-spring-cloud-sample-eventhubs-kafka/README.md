...
[application.yaml]: https://github.com/Azure-Samples/azure-spring-boot-samples/eventhubs/azure-spring-cloud-sample-eventhubs-kafka/src/main/resources/application.yaml