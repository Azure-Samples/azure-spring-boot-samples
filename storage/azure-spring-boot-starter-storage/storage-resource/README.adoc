...
:application-properties: https://github.com/Azure-Samples/azure-spring-boot-samples/blob/main/storage/storage-resource/src/main/resources/application.properties
