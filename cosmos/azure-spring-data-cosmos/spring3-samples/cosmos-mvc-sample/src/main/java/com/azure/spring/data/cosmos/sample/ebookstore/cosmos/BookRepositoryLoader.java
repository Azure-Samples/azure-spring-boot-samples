...
public class BookRepositoryLoader {
    ...
    public void loadBooksToBookRepository() {
        ...
        books.add(new Book("30", "Security", "23123", "Modern Authentication with AzureAD ", "Vittorio Bertocci", "Microsoft Entra ID capabilities", new BigDecimal(40.00), new BigDecimal(30.00), "/images/AzureAD.jpg"));
